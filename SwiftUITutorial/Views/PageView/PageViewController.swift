...
struct PageViewController<Page: View>: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
        ...
        // Определяет, какой viewController должен отображаться перед текущим при пролистывании влево
        ...
        // Определяет, какой viewController должен отображаться после текущего при пролистывании вправо
